...
### Navigation — what experience actually is
...
![Figure 7 — Navigation: a stream's trajectory through configuration space, pulled by coherence-attractors (+) and pushed by repellors (−); each point on the path is one informed collapse — a measurement of the next configuration. The moving is the experiencing; no observer sits behind it watching.](where-we-stand-assets/fig7-navigation.png)
