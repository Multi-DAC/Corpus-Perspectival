"""DETACHED launch: exam-camera fine-tune off best.pt (+256.28, maneuver_scale_2).
...
Seeds a FRESH logdir (maneuver_band_ft) with best.pt as latest.pt — the scale-2 run's
...
SRC_BEST = os.path.join(DREAMER, "logdir", "maneuver_scale_2", "best.pt")
LOGDIR = os.path.join(DREAMER, "logdir", "maneuver_band_ft")
LOG = os.path.join(DREAMER, "logdir", "band_ft_orchestrator.log")
...
if not os.path.exists(latest):
    ...
    print(f"seeded {latest} from maneuver_scale_2/best.pt")
else:
