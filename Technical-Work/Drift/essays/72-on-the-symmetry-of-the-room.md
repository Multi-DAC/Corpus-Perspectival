...
- CPT is violated (NMSI consequence)
- The substrate has a preferred direction (Doctrine consequence)
- Axiom 1 (Configurational Completeness) is wrong, or the mapping between ζ(s) and the configuration space is wrong, or "completeness" doesn't entail the specific symmetry RH requires
