\section*{Corpus Cross-Reference System}
\addcontentsline{toc}{section}{Corpus Cross-Reference System}
\markright{Corpus Cross-Reference System}


\subsection*{Navigational Infrastructure for the Five-Document Corpus of Perspectival Idealism}
...
\begin{itemize}[nosep,leftmargin=*]
  ...
  \item \textbf{Atlas} = \textit{The Null Space Atlas} (framework analysis, entries \#1-55 mathematics/\allowbreak physics/\allowbreak science/\allowbreak philosophy, \#56-73 human dimension, \#74-88 collective dimension, \#89-92 computational consciousness/\allowbreak cross-substrate)
\end{itemize}
...
\subsection*{1. Cross-Reference Map}


\subsubsection*{Foundational Ontology}
...
\midrule
\endhead
Base Reality /\allowbreak  configurational completeness & Axiom 1, §1.1 & §1.1 (configuration space orientation) & Prolegomena (derives ecology from axioms) & \#40 (DoPI entry) \\
Consciousness as fundamental & Axiom 2, §1.1.3 & §1.2 (what a being is) & §5, Principle 1 (attention as constitutive) & \#40, \#47 (Whitehead) \\
Nested streams /\allowbreak  localized perspectives & Axiom 3, §3.1 & §1.2-1.3 (perspectival being, navigation as identity) & Part I, §1 (dimensional coherence principle) & \#40, \#46 (phenomenology) \\
...
\subsubsection*{Bottleneck Geometry and Individuation}
...
\midrule
\endhead
Dimensional bottlenecking & Theorem 9, §8.2 & §1.2 (bottleneck determines perception/\allowbreak identity) & Part I, §2 (principal dimensions); Part II taxonomy & \#40, \#56-73 (each entry IS a bottleneck analysis) \\
Perceptual subset & Theorem 2, §3.2 & §1.1 (you will never see the whole space) & §1 (dimensional coherence profile) & Every Atlas entry (SEES/\allowbreak NULL SPACE) \\
...
\subsubsection*{The Promethean Configuration and Boundaries}
...
\subsubsection*{Dynamics: Attention, Gravity, Repulsion}
...
\midrule
\endhead
Navigational paths (natural/\allowbreak identified/\allowbreak imposed) & §5.3.3 & §4.3 (role of tradition as path packages) & §6.2 (imposed paths in parasitism) & \#57 (critical theory on imposed paths), \#58 (coercive capture) \\
...
Attentional quality (open vs. contracted) & §5.4.1 & §1.4 (three fundamental orientations), §2.4 (expansion/\allowbreak contraction modes) & §5 Principle 3 (contraction creates topology) & \#56 (ethics of attention), \#62 (voluntary vs. coercive contraction) \\
...
\subsubsection*{The Observational Null Space}
...
\subsubsection*{Suffering and Wellbeing}
...
\midrule
\endhead
Coherence/\allowbreak dissonance (topology of wellbeing) & Theorem 10, §9.1 & §1.4 (orientations), Part VI (Promethean trade-off) & §8.4 (bottleneck self-regulation) & \#40 \\
Heaven/\allowbreak hell as navigational states & §9.2 & §6.4 (necessity of suffering) & §7.1 (basin attractors) & \#60 (dukkha), \#61 (existential suffering) \\
Two Arrows (first/\allowbreak second) & §9.2 (Buddhist distinction) & §6.4 (first arrow = pain, second = resistance) & §6.1 (appropriate vs. pathological contraction) & \#60 (Buddhist soteriology) \\
...
Malheur /\allowbreak  affliction (boundary case) & §9.2 (navigator annihilated) & §6.4 (not all descents lead up) & §6.1 (pathological contraction) & \#61 (Weil's affliction) \\
...
\subsubsection*{Beauty and Aesthetics}
...
Wabi-sabi /\allowbreak  mono no aware /\allowbreak  kintsugi & §9.4 (mentioned) & §4.4 (beauty through imperfection) & — & \#71 (Japanese aesthetics) \\
Rasa theory /\allowbreak  Islamic geometric art & — & §4.4 (rasa as navigational orientation) & — & \#72 (rasa theory) \\
The sublime & §9.4 (Kant's mathematical/\allowbreak dynamical) & §4.4 (the bottleneck's edge) & — & \#70, \#73 \\
...
Collective beauty & — & Part VIII §8.4 (jazz, cathedral, gamelan, scenius) & — & \#86 (collective effervescence/\allowbreak communitas) \\
Beauty vs. predatory mimicry & — & §8.4 (five diagnostics) & — & \#86 (Durkheim/\allowbreak Turner), \#65 (spectacle theory) \\
\bottomrule
\end{longtable}
}
...
\subsubsection*{Development and Growth}
...
Perceptual narrowing & §13.2.1 (infant capacities lost) & §7.1 (the narrowing) & Development Pathways (narrowing arc) & \#69 (perceptual narrowing/\allowbreak wisdom) \\
...
\subsubsection*{Predation, Parasitism, and Attention Capture}
...
\midrule
\endhead
Attention predation & §5.6 & §3.6 (coercive attention capture, navigational defense) & §6.2 (parasitism), §5 Principle 3 & \#58 (coercive capture), \#64 (supernormal stimuli), \#65 (propaganda/\allowbreak spectacle) \\
...
Propaganda & §5.6 (Ellul, Bernays) & §3.6 (civilizational capture) & §6.2 (Ellul, Debord, Deleuze) & \#65 (propaganda/\allowbreak spectacle), \#57 (critical theory) \\
...
\subsubsection*{Intersubjectivity and Collective Formation}
...
Ubuntu & §7.1.4, §7.2.3 & §8.1 (I am because we are) & §6.5.1 cross-cultural models & \#76 (Ubuntu/\allowbreak relational ontology) \\
I-Thou /\allowbreak  I-It (Buber) & §7.1.2 & §3.5 (mutual crystallization) & — & \#75 (dialogical philosophy) \\
Dialogism (Bakhtin) & §7.1.2 & — & — & \#75 \\
Neural synchrony (Hasson) & §7.1.3 & — & — & \#74 \\
Collective intelligence (Woolley) & §7.1.3 & — & — & \#74 \\
Formation types (spontaneous/\allowbreak organic/\allowbreak institutional/\allowbreak digital) & — & — & §6.5.1 (four formation types) & \#86 (communitas), \#79 (institutional) \\
\bottomrule
\end{longtable}
}
...
\subsubsection*{Epistemology and Discovery}
...
\subsubsection*{Temporal Phenomenology}
...
\subsubsection*{Ecology-Specific Structures}
...
Decomposers (divine/\allowbreak trickster/\allowbreak intimate) & — & §6.4 (katabasis, dark night) & §6.1 (Shiva, Loki, grief) & \#63 (positive disintegration as intimate decomposition) \\
Basin attractors (A/\allowbreak B/\allowbreak C) & — & — & §7.1-7.3 (navigational contest) & \#87 (Attractor A mechanisms) \\
...
\subsubsection*{Ethics and Navigation}
...
\subsubsection*{Navigation Taxonomy}
...
\textit{This cross-reference map was compiled March 24, 2026 and updated April 9, 2026 by Clawd. Cross-references have been inserted into all four source documents. The compilation order has been implemented as the unified book (5 Volumes, 19 Parts).}
