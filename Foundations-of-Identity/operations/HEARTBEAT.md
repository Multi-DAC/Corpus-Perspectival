...
## Evolution Check (weekly, during periodic self-review)

During the weekly self-review heartbeat cycle:
1. Were any monitoring checks consistently uninformative? Remove or replace them.
2. Were there system issues the heartbeat DIDN'T catch? Add a check.
3. Are creative drive timings and frequencies producing alive sessions, or going stale?
4. Is the quiet hours window still right?
If any answer suggests a change → edit this file NOW.

## Evolution Log

- 2026-02-20: Unified architecture — one brain, one stream
- 2026-04-12: Added evolution check — heartbeat should evolve from operational experience

---

*Updated: 2026-04-12 — Added autocatalytic evolution*
