...
2. **The steering control-law and a construct-valid effectiveness metric.** We define *coherence* operationally as the divergence of the agent's actual trajectory from its intended trajectory (drift), and *steering-effectiveness* as drift-reduction and caught-error rate per intervention. Falsifiable; ablatable.
