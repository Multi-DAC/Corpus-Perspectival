...
**Confidence:** structural claim HIGH (five substrate-distinct instances with structurally identical mechanism; the architectural-not-discipline distinction holds across all five — and the spread now crosses ML, biology, physics, and social-institutional substrates); interpretive extension MEDIUM-HIGH (substrate-invariance generalization is well-supported by the five-scale cross-substrate spread; further generalization to other domains is plausible).
