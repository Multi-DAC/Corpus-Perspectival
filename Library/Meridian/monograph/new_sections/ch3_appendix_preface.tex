...
%%
%% STATUS: SUPERSEDED (2026-04-21, v2 sync pass S2).
%% Contents have been integrated into chapter3_nogo.tex,
%% appendix_computations.tex, and the monograph preamble.
%% The C_KK value in Block 3 ((2.45 +/- 0.83) x 10^-4) is a
%% historical pre-correction value; the canonical value is
%% (1.64 +/- 0.33) x 10^-4 (Appendix D Tier 2). Retained only
%% as drafting-lineage artifact; not \input{} into the monograph.
%%
