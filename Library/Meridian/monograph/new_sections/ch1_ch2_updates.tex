...
%
% STATUS: SUPERSEDED (2026-04-21, v2 sync pass S1).
% The content in this file has been integrated into
% chapter1_foundation.tex (Remark 1.11 at line ~1793, with the
% improved "three derivations + four consistency checks"
% decomposition) and chapter2_observational.tex. The bare
% "seven-fold convergence" framing below is historical; the
% canonical book-internal statement is Appendix A §app:xi
% ("three complementary perspectives on a single geometric
% fact") with Ch 1 Rem. 1.11 as the detailed elaboration.
%
% Not \input{} into meridian_monograph.tex; retained only as
% drafting-lineage artifact.
% ============================================================
