...
*Library volume: formal-only companion. Domain: formal grounding. Status: **planned** — opens after *The Coherence Principle* stabilizes. Added to library: 2026-04-19 (Day 78).*
...
*The Coherence Principle* is the paired-prose + CT foundational volume (pair-first). The Formal Object Companion is its CT-only derivative — the same formal objects stripped of their prose partners and reorganized CT-lattice first.
...
- Every domain example is deleted (they live in the domain volumes and in *The Coherence Principle*)
- Proofs are tightened; proof-sketches in *The Coherence Principle* are either completed or clearly marked open
- Notation is unified and indexed at the front
- Appendices A (Index of Formal Objects) and B (Bias(S)) from *The Coherence Principle* are the core of the Companion — they already exist in close-to-final form
...
2. Reorder from pedagogical (foundational volume) into formal-dependency (Companion)
...
**Sequencing:** *The Coherence Principle* first. The Companion derives from it; it doesn't precede it. Building the Companion before the foundational volume is stable would mean chasing edits.
