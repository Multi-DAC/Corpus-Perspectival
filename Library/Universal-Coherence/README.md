...
3. Specify constituency: religious experiences → doctrines → traditions → the theological canon; note that ultimacy-claims may be at the limit of what constituency describes
4. Project the Triple: Form (doctrinal structure), Content (scriptural/mystical text), Carrier (practicing communities + their textual corpus + their lineages)
5. Locate Bias(S): traditions have pull-toward-specific-ultimacies (apophatic vs. cataphatic, immanent vs. transcendent, personal vs. impersonal)
6. Instantiate the Principle: what does coherence look like in a theological position? How are the four conditions met when the target is nominally beyond streams?
7. Specify falsification: when does a theological position fail? Under what conditions are traditions abandoned, reformed, or absorbed?

Theology is the hardest filter to apply cleanly because it touches the boundary where the framework's native vocabulary (streams, DOF, measurement) thins out. The volume will be explicit where it gestures past its own tools rather than pretending the tools reach further than they do.

---

## Reading queue

See [`Research/philosophy-theology-reading-queue.md`](../../Research/philosophy-theology-reading-queue.md) for the active register. Primary authors:

- **Whitehead** — Process and Reality (God-chapter especially; also in Philosophy)
- **Plotinus** — Enneads (V, VI especially — the One and procession)
- **Pseudo-Dionysius** — Mystical Theology, Divine Names
- **Meister Eckhart** — German Sermons
- **William James** — Varieties of Religious Experience
- **Evelyn Underhill** — Mysticism
- **Nagarjuna** — Mulamadhyamakakarika (two-truths, śūnyatā)
- **Shankara** — Brahmasutrabhasya (Advaita)
...
6. Apophaticism — descriptive-functor limits and negative theology
7. Religious experience — contracted-coherent and expanded-coherent as dual forms
8. Comparative traditions — Buddhist, Advaita, Taoist convergences and divergences
