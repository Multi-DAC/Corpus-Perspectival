...
This volume is the philosophy-proper treatment of the framework — refined from the Corpus/DoPI register with full tradition engagement. It takes the Anchor's formal grounding and applies it to the problems, vocabulary, and debates of the philosophical tradition.

**What this volume covers:**
- Neutral monism — Mach, James, Russell, and the framework's position relative to the lineage
- The hard problem of consciousness — why A1 dissolves it rather than solving it
...
- Ultimacy, religious experience, transcendence-as-practice — Theology
...
3. Specify constituency: arguments → positions → traditions → philosophical canon
4. Project the Triple: Form (structural claims), Content (arguments and texts), Carrier (the embodied thinkers + written corpus)
5. Locate Bias(S): philosophical pull-toward what positions (epistemic preferences, school affiliations)
6. Instantiate the Principle: what does coherence look like in a philosophical position? At what refresh-rate? Across what scales (argument → position → tradition)?
7. Specify falsification: how do philosophical positions fail? Under what conditions do they get abandoned?
...
- **Whitehead** — Process and Reality (also in Theology)
...
2. Neutral-monist grounding — A1 in the philosophical tradition
3. Stream-structure — A2 as philosophy of mind
4. Conscious gravity — A3 as philosophy of agency/teleology
5. The perspectival functor — T1 and the descriptive-functor meta-theorem
6. The hard problem dissolved
7. Personal identity and the Triple
8. Transcendentals and abstraction (bridge to Theology)
