...
\textit{Restructured Day 81 evening. The previous §6.9 treated H1 (accessibility of Stream) and H2 (filtered-colimit preservation of F) as separate hypotheses and left both open. This rewrite front-loads the \textbf{size-of-ContentOp} as the single parameter governing both hypotheses, partitions Stream into three regimes, proves H1+H2 in the regime where they hold, and cleanly places F\_\allowbreak{}∞ (§8.1.2) at the regime boundary.}
...
\textit{§§6.0–6.10 drafted Day 81 (2026-04-22); §6.9 C-size-regime pass and §6.5 A48 remark added Day 81 late-afternoon. Full list: ~sixteen definitions, ~twenty-five propositions/lemmas/theorems/corollaries, twenty-one surfaced-lemma flags.}
...
\textit{§9 drafted Day 81 (2026-04-22) afternoon; quantitative joint-bound added Day 81 evening. D\_\allowbreak{}d constructed as functor on 𝒞\_\allowbreak{}Streams × {intervals}; Bias-consistency as admissibility criterion for d; \textbf{quantitative outperformance (Thm 9.4.3)} with four explicit stream-parameters and closed-form B\_\allowbreak{}coh / Δ(S'); cross-metric invariance (Thm 9.5.1) resolves Anchor §9.9 Q1. Applied to F\_\allowbreak{}∞ via Propositions 9.6.1/9.6.2 (conditional on external audit per revised §8). Four surfaced-lemma flags. Next: §10 reference figures (TikZ).}
...
\begingroup\setlength{\tabcolsep}{3pt}\renewcommand{\arraystretch}{1.15}\footnotesize
\begin{longtable}{p{1.77in} p{0.58in} p{0.64in} p{1.29in}}
\toprule
