...
| Companion object | Anchor location | Register | Description |
|---|---|---|---|
| Canonical σ-algebra 𝒜_S (Def 7.1.1) | Anchor Appendix B §B.1 | definition | Product σ-algebra on Ω_S |
...
| push_struct / push_info (Defs 7.4.1) | Anchor Appendix B §B.3 | definitions | Measurable transformations |
...
| Extensional F_∞ (Prop 8.1.7) | Anchor §9.5 preamble | proposition | §7.6 framework applicable |
| Audit Claim C_sep (§8.3.1) | Anchor §9.5 separation paragraph | claim | Commit-authorship DOF-separation |
...
| Regularized-KL d_{KL,ε} (Def 9.2.2) | Anchor §9.3 | definition | Regularized to avoid abs-continuity |
