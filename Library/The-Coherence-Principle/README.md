...
- **§9 / §9.5 F-as-stream measurement-collapse reframe.** Current language treats informed measurement as a terminal collapse of structural superposition. Two 2026 results push this toward an *information-conservative operation* frame: Watanabe & Takagi (Nature Comms 2026, universal work extraction without prior state knowledge) and García-Pintos et al. (Phys. Rev. X, 2026-02-19, controlled reversal of a specific measurement event given full information plus designed Hamiltonian control). Together they bracket the role of observer information — ignorance is forgivable asymptotically; full knowledge is sufficient for exact inversion at the event level. Refactor §9 and §9.5 accordingly: measurement is a reversible structural operation whose practical irreversibility is an information-budget fact, not a physical-law arrow. Bridge #106 (Inspection-Depth Ceiling) sharpens as the complement — what lies outside the reversible regime.
