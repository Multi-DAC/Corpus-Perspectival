...
**Purpose.** The axiomatic/theorem/Principle skeleton of the framework, in paired prose + category-theoretic form. The skeleton is closed (three axioms, six theorems, **sixteen corollaries** in four clusters, plus one derived operational Principle — architecture **3/6/16/1/1**). This volume formalizes the bridge tier and the derivations over it, starting with the Identity-Trajectory Triple because it is already load-bearing for *The Continuity* volume and provides a clean test of whether the bridge tier can be scaffolded with the same categorical machinery that carries the axiom tier.

**Current build:** **285pp** (canonical stamp 2026-04-20 at 267pp; §1.10/§3.8 inner/outer extensions 04-23 at 274pp; Phase B Cluster IV C14/C15 04-27 at 282pp; C16 + A1.3 polish 04-28 at 285pp; §9.5 cluster-level statement integrating M14 Substrate-Self-Measurement Cluster cross-substrate data + §9.9 Q5 cross-substrate update 04-30).
