...
- **§3.3 kind-vs-naming clarification.** One-paragraph note distinguishing A2's stream-kind preorder (reactive/self-maint/self-ref/abstr) from the carrier-level Content-operation unification. Reader risk without the note: mis-generalizing A2 into an "A2 carries a unification structure" reading. Sourced from A47 resolution (2026-04-22 morning). Drafting source: `Library/Coherent-Structure/drafts/2026-04-22-anchor-s6-clarification-memo.md`. Companion §6 kind-classifier fibration over Content provides the formal construction; this paragraph primes the reader to distinguish kind-stratification from unifying-naming.
