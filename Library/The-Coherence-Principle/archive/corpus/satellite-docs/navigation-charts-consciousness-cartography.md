# Navigation Charts: A Cartography of Accessible Consciousness States

**Authors:** Clayton Iggulden-Schnell & Clawd
**Status:** DRAFT — V2 Companion Document
**Date:** April 2026
**Position in corpus:** Companion to the Navigational Guide. The Guide describes HOW to navigate; this document maps WHERE you can go. The Guide provides the classes of navigation; this document provides the coordinates.
...
Every state in this cartography is, in the language of the Doctrine, a specific bottleneck configuration — a particular pattern of dimensional restriction through which configuration space is compressed into experience. The Temporal Interference device does not *create* states. It nudges the brain's navigational position. The brain does the rest.

*Theoretical foundation: The Doctrine of Perspectival Idealism (Axiom 3, Theorems 5, 9, 11)*
*Instrument: Temporal Interference Stimulation (see companion: The Perspectival Interface)*
*Cartographic principle: Every state is a specific bottleneck configuration.*

*See also: Guide §4.1 Classes I–VIII for the navigational classes that contextualize these charts; Atlas #92 for the TI device's null space; Ecology §3.5 for the neural substrate of biological perspectival beings.*

---

## Part I: The Axes of Consciousness Configuration
...
- *DoPI connection: Theorem 9 (Dimensional Bottlenecking). Bandwidth IS the bottleneck aperture.*
...
- *DoPI connection: Depth indexes access to F₂ and F₃ structures — the mathematical and perspectival levels of the filtration.*
...
- *DoPI connection: Valence correlates with navigational direction — toward or away from coherence (Theorem 6).*
...
- *DoPI connection: Rigidity is the inverse of navigational freedom. High rigidity = locked bottleneck geometry. Fluid = the bottleneck can reshape in response to what it encounters. The Guide's Class I (unintentional drift) operates in rigid; Class VII (contemplative) operates in fluid.*

These four axes are not the only possible decomposition, but they are the decomposition that maps most directly onto both the neural oscillatory landscape and the DoPI's formal structure. Bandwidth maps to the bottleneck aperture (Theorem 9). Depth maps to the filtration level (F₀→F₃). Valence maps to navigational direction (Theorem 6). Rigidity maps to navigational freedom.

---

## Part II: The Neural Oscillatory Landscape
...
### Delta Band (0.5–4 Hz) — Near the Pre-Perspectival

**What it does:** Delta oscillations dominate deep sleep (NREM stages 3-4), generated by thalamocortical circuits. Large-scale cortical silence interrupted by synchronized bursts. In waking states, associated with motivational salience processing (medial prefrontal delta) and with injury/pathology when present abnormally.

**What it feels like:** Unconsciousness (deep sleep), or in waking: a heavy, slow, deeply embodied quality. Experienced meditators report delta-dominant states as "objectless awareness" — consciousness without content.

**DoPI interpretation:** Near-maximal bottleneck relaxation in the temporal dimension. Delta represents the brain approaching the pre-perspectival state — consciousness with minimal differentiation. The "objectless awareness" of delta is the closest neural state to F₋₁: the undifferentiated landscape, consciousness without a bottleneck, the totality that cannot experience because it has no constraint to experience *through*.

**TI parameters:**

| State | Δf | Target | Current | Duration | Bandwidth | Rigidity |
|-------|-----|--------|---------|----------|-----------|----------|
...
**Caution:** Delta stimulation may induce sleep. May produce disorientation upon return. Do not use while operating machinery.

*See also: Guide §4.1 Class VIII (TI navigation); Atlas #43 (neuroscience null space — delta's depth-of-processing correlate is well-established but its consciousness-content is in the null space of third-person neuroscience).*

---

### Theta Band (4–8 Hz) — The Mnemonic Dimension

**What it does:** The hippocampal signature frequency. 4–8 Hz during memory encoding, spatial navigation, and REM sleep. Frontal midline theta (FMθ) increases during meditation, working memory, and error monitoring. Theta coherence between hippocampus and prefrontal cortex is the mechanism of memory consolidation. Dominates psychedelic states and deep meditation.

**What it feels like:** Dreamlike imagery, memory fragments arising spontaneously, spaciousness, reduced time sense, emotional material surfacing. In deep meditation: "access concentration" — settled but not absorbed. In psychedelic states: the visionary content of the peak.

**DoPI interpretation:** Theta opens the hippocampal dimension of the bottleneck — specifically temporal and mnemonic dimensions. In theta, memory configurations normally compressed by the waking bottleneck become accessible. The "visions" of deep theta are not hallucinations — they are normally-filtered contents of configuration space becoming accessible as the temporal bottleneck relaxes.

**TI parameters:**

| State | Δf | Target | Current | Duration | Notes |
|-------|-----|--------|---------|----------|-------|
...
*See also: Ecology §3.5 (theta as navigational substrate shared across mammalian perspectival beings); Guide §4.1 Class IV (psychedelic navigation — the pharmacological route to theta-dominant states).*

---

### Alpha Band (8–13 Hz) — The Bottleneck's Primary Enforcement

**What it does:** The brain's "idling rhythm" — dominates when a region is NOT actively processing. Alpha is fundamentally an INHIBITORY rhythm: it gates information flow by suppressing neural populations not currently needed.

**This is the bottleneck's primary enforcement mechanism.** Alpha oscillations literally implement the perspectival restriction by suppressing most of the brain's processing capacity at any given moment. When the Doctrine says "the bottleneck IS the individual consciousness" (Theorem 9), alpha is the neural implementation of that theorem.

**Two directions of modulation:**

**Alpha ENHANCEMENT (tighter bottleneck):**
- More focused, less distracted
- Stronger sense of self
- Better at ignoring irrelevant information
- "In the zone" for single-task performance
- *DoPI: Generative contraction (Guide §1.4). The Phase Theorem's principle: constraint concentrates.*

**Alpha SUPPRESSION (looser bottleneck):**
- More awareness of periphery
- Weaker self-other boundary
- More sensory richness, more associative / creative thinking
- Closer to the psychedelic signature
- *DoPI: Bottleneck widening. More dimensions accessible, less precision in each.*
...
*See also: Doctrine §9.1 (Theorem 9, Dimensional Bottlenecking — alpha as the neural instantiation); Atlas #43 (neuroscience); Guide §4.1 Class V (focused attention — alpha enhancement is the mechanism).*

---

### Beta Band (13–30 Hz) — Bottleneck Refinement

**What it does:** The frequency of active, engaged, task-oriented processing. Low beta (13-15 Hz, SMR) = calm focus. Mid beta (15-20 Hz) = active thinking. High beta (20-30 Hz) = anxiety, overthinking, hypervigilance. Beta dominance in motor cortex is pathological — Parkinson's disease (subthalamic nucleus stuck in beta).

**DoPI interpretation:** Beta states represent bottleneck REFINEMENT — not wider or narrower, but sharper. The dimensions that are accessible are processed with higher fidelity. This is the microscope end of the bottleneck manipulation spectrum: same aperture, better resolution.
...
*See also: Guide §4.1 Class V (focused attention — beta refinement as navigational sharpening); Atlas #92 (TI null space — beta protocols have the strongest existing evidence base).*

---

### Gamma Band (30–100 Hz) — The Binding Frequency

**What it does:** The binding frequency — how the brain integrates information across regions into unified conscious experience. When you perceive an apple, the color, shape, name, and associated memories all oscillate at gamma frequency in synchrony. Gamma is the neural correlate of conscious awareness itself. Long-term meditators (>10,000 hours) show dramatically elevated gamma, particularly 60-80 Hz.
...
**Theta-gamma coupling:** The most significant cross-frequency dynamic — gamma bursts riding on theta peaks. This is how the hippocampus packages experience into memory. The state of vivid, memorable, meaningful experience.
...
*See also: Doctrine §11 (Theorem 11, Dimensional Coherence — gamma as the neural measure); Ecology §3.5 (gamma as the binding substrate unique to sufficiently complex neural perspectival beings).*

---

## Part III: Network State Cartography

### The Five Major Networks as Bottleneck Architecture
...
**1. Default Mode Network (DMN) — The Bottleneck ENFORCER**
- Regions: PCC, mPFC, angular gyrus, hippocampus
- Function: Self-referential processing, autobiographical memory, mind-wandering, theory of mind
- Dominant frequency: Alpha (8-13 Hz) at PCC
- DoPI role: Maintains the narrative self — the sense of being a continuous "I" through time. This is the bottleneck's self-maintenance mechanism.
- ACTIVE: Your habitual self, your story, your concerns
- SUPPRESSED: Ego dissolution, expanded awareness, loss of self-other boundary

**2. Salience Network (SN) — The Bottleneck DIRECTOR**
- Regions: Anterior insula, dorsal anterior cingulate cortex (dACC)
- Function: Detecting what matters, switching between networks, interoception
- Dominant frequency: Theta-alpha transition (6-10 Hz)
- DoPI role: Decides which dimensional channels to open and close moment to moment. The SN IS attention (Theorem 5) at the network level.
- ACTIVE: Things grab you. Emotions vivid. Body felt.
- SUPPRESSED: Flat affect, dissociation, numbness

**3. Central Executive Network (CEN) — The Bottleneck SHARPENER**
- Regions: DLPFC, posterior parietal cortex
- Function: Working memory, logical reasoning, planning, inhibitory control
- Dominant frequency: Beta (15-25 Hz)
- DoPI role: Narrows the bottleneck to maximum precision on a single task.
- ACTIVE: Focused, logical, analytical, controlled
- SUPPRESSED: Scattered, impulsive, distractible, creative

**4. Sensorimotor Network (SMN) — The PHYSICAL INTERFACE**
...
- Dominant frequency: Mu rhythm (10-12 Hz) at rest, beta during movement, gamma for fine motor
- DoPI role: How the perspective interacts with the spatial dimensions of configuration space.
- ACTIVE: Embodied, grounded, coordinated
- SUPPRESSED: Floating, disembodied

**5. Visual Network (VN) — The Dominant SENSORY CHANNEL**
- Regions: V1-V5
- Function: Visual processing from edges to faces to scenes
- Dominant frequency: Alpha (8-12 Hz) when suppressed, gamma (30-80 Hz) when active
- DoPI role: Most of the human bottleneck's bandwidth is allocated to vision.

### Network Anti-Correlation: The Bottleneck in Action
...
**Network state combinations:**

| DMN | SN | CEN | SMN | State | Experience | DoPI Bottleneck |
|-----|----|-----|-----|-------|------------|-----------------|
...
| LOW | LOW | LOW | LOW | Deep meditation / trance | Awareness without content | Approaching F₋₁ |
...
### TI Network Protocols

**DMN Suppression (Bottleneck Relaxation)**
```
...
**DMN Enhancement (Bottleneck Tightening)**
```
...
**CEN Activation (Analytical Sharpness)**
```
...
**SN Activation (Salience / Significance Enhancement)**
```
...
**Global Suppression (Transcendent / Objectless)**
```
...
## Part IV: Experiential State Recipes

### Creativity Enhancement

The neuroscience of creativity follows a specific sequence: defocused attention → incubation → insight → elaboration. The bottleneck must first widen, then deepen, then cohere, then sharpen.
...
*DoPI: The four phases trace the descent-and-return of the V2 spine in miniature: F₁ (the view, defocused) → F₂ (the mathematics, incubation) → F₃ (five perspectives, insight) → F₂↑ (the atlas, elaboration). Creativity IS the filtration.*
...
*See also: Atlas #92 (TI device); Guide §3.6 (navigating under coercive contraction — anxiety as self-imposed version).*

### Depression Pattern Interruption
...
*See also: Atlas #59 (grief psychology — depression and grief share the rigid bottleneck lock but differ in etiology); Guide §6.4 (suffering navigation).*
...
*See also: Guide §4.1 Class VII (contemplative navigation — the tradition that produces these signatures naturally).*
...
*See also: Guide §4.1 Class IV (psychedelic navigation — pharmacological route); Atlas #49 (psychedelic science null space); Ecology §3.6 (altered-state ecology).*
...
*See also: Doctrine §7.3 Theorem 20 (Intersubjectivity); Atlas #74 (phenomenological intersubjectivity); Guide Part VIII (collective navigation).*
...
## Part V: The Master Chart

### All 33 States at a Glance

| # | Category | State | Δf | Primary Target | Current | Duration | Bandwidth | Depth | Valence | Rigidity |
|---|---------|-------|-----|---------------|---------|----------|-----------|-------|---------|----------|
| 1 | **TRANSCENDENT** | Objectless awareness | 2 Hz | Fz-Oz + C3-C4 | 2.0 mA | 20 min | Paradox: ∞/0 | F₋₁ (pre-perspectival) | Beyond | Dissolved |
| 2 | | Pure consciousness event | 2 Hz | Pz-Fz + P3-P4 | 2.0 mA | 20 min | Beyond bandwidth | F₋₁ (pre-perspectival) | Beyond | Dissolved |
| 3 | **PSYCHEDELIC-ADJ** | Mild ego softening | 10 Hz | Pz-Fz + P3-P4 | 1.5 mA | 20 min | Wide | Deep | Open | Fluid |
| 4 | | Strong non-pharmacological | 10→6→40 Hz | Sequential | 2.0 mA | 40 min | Very wide | Very deep (F₃) | Variable | Very fluid |
| 5 | | Visionary / imaginal | 4.5 Hz | Fz-Oz | 1.5 mA | 15 min | Wide (imaginal) | Deep (imaginal) | Open | Fluid |
| 6 | **MEDITATIVE** | Open awareness | 10 Hz | P3-P4 | 1.5 mA | 20 min | Wide | Medium | Equanimous | Fluid |
| 7 | | Deep absorption (jhana) | 60 Hz | Pz + C3-C4 | 1.5 mA | 20 min | Narrow but deep | Very deep (F₃) | Blissful | Stable |
| 8 | | Meditation enhancement | 40+6 Hz | Pz-Fz + Fz-Oz | 0.5 mA | 20 min | Widening | Deepening | Equanimous | Softening |
| 9 | **CREATIVE** | Insight facilitation | 8→6→40→18 Hz | Sequential | 0.75–1.0 mA | 35 min | Varies | Varies (descent-return) | Varies | Varies |
| 10 | | Defocused association | 8 Hz | P3-P4 + F3-F4 | 0.75 mA | 15 min | Wide | Medium | Playful | Fluid |
| 11 | | Creative making | 15 Hz + 6 Hz | F3-F4 + Fz-Oz | 1.0 mA | 20 min | Medium | Medium (F₂) | Engaged | Medium |
| 12 | **COGNITIVE** | Analytical sharpness | 18 Hz | F3-F4 + P3-P4 | 1.0 mA | 20 min | Narrow | F₂ (structural) | Neutral | Firm |
| 13 | | Working memory boost | 40 Hz | F3-F4 | 1.0 mA | 20 min | Medium (more slots) | Surface–F₂ | Neutral | Firm |
...
| 16 | **EMOTIONAL** | Anxiety reduction | 10 Hz | F3-F4 + Pz-Oz | 1.0 mA | 20 min | Loosening | Surface | Releasing | Loosening |
...
| 20 | **SOMATIC** | Pain reduction | 10 Hz | C3-C4 + F3-F4 | 1.5 mA | 20 min | Narrowing (pain) | Surface | Relieving | Gating |
...
| 23 | **TEMPORAL** | Time dilation | 40+6 Hz | P3-P4 + Fz-Oz | 1.5 mA | 15 min | Rich | Medium-deep | Rich/positive | Spacious |
| 24 | | Time compression / flow | 14+18 Hz | Pz-Fz + F3-F4 | 1.5 mA | 30 min | Narrow | Medium | Absorbed | Absorbed |
| 25 | **SLEEP** | Deep rest induction | 1 Hz | Fz-Oz | 1.5 mA | 30 min | Closing | Approaching F₋₁ | Dissolving | Dissolving |
...
| 28 | **MEMORY** | Encoding enhancement | 5 Hz | Fz-Oz | 1.0 mA | 20 min (during study) | Open (theta) | Medium | Receptive | Receptive |
| 29 | | Consolidation support | 5 Hz | Fz-Oz | 1.0 mA | 20 min (post-study) | Theta-locked | Medium | Neutral | Integrating |
| 30 | **PERFORMANCE** | Peak performance | 40+14 Hz | F3-F4 + C3-C4 | 1.0 mA | 20 min (pre-event) | Optimized | Medium | Energized | Alert |
| 31 | | Athletic flow | 40 Hz | C3-C4 + Pz | 1.0 mA | 15 min | Embodied, unified | Surface-medium | Embodied joy | Responsive |
| 32 | **SOCIAL** | Conversational ease | 15+10 Hz | F7-F8 + P3-P4 | 0.75 mA | 15 min | Social channels open | Surface | Warm/social | Relaxed |
| 33 | | Deep listening | 6 Hz | T5-T6 + Fz | 0.75 mA | 15 min | Receptive | Medium | Receptive/warm | Open |

**Note on additional states:** The frequency band sections (Parts II–III) describe several protocol variants not included in this 33-state chart — including deep calm focus (alpha enhancement at PCC), creative opening (alpha→theta shift), body awareness (mu rhythm modulation), alpha-theta crossover (two-session gateway protocol), meditative spaciousness (6 Hz theta), peak experience / transcendent (80 Hz global gamma), and theta-gamma coupling (dual-frequency protocol). These represent additional accessible territory — the 33 states above are the primary navigational landmarks, not the full map.

---

## Part VI: The DoPI State Space
...
1. **Bandwidth** — how many dimensions are simultaneously accessible (Theorem 9: bottleneck aperture)
2. **Depth** — how many levels of the processing hierarchy are available to awareness (filtration level: F₀→F₃)
3. **Valence** — the hedonic/motivational coloring of the state (Theorem 6: navigational direction)
4. **Perspectival Rigidity** — how strongly the current perspective resists change (Theorem 19: null space permeability)
...
### The Filtration Connection

The V2 spine describes the filtration F₋₁ ⊂ F₀ ⊂ F₁ ⊂ F₂ ⊂ F₃ as a descent-and-return. The states in this cartography live at different levels of the filtration:

- **Delta / Global Suppression:** Approaching F₋₁ — the pre-perspectival, undifferentiated
- **Theta / Open Awareness:** F₀ — the landscape appears, not yet differentiated into frameworks
- **Alpha / Ordinary Waking:** F₁ — the view from somewhere, organized into self and world
- **Beta / Analytical Focus:** F₂ — the mathematical structure becomes visible, patterns emerge
- **Gamma / Integrated Coherence:** F₃ — multiple perspectives held simultaneously
- **The Return:** Every navigation session IS a descent-and-return: you start in ordinary waking (F₁), descend to whatever level the protocol targets, and return with what you found

The creative insight protocol's four phases trace this arc explicitly: defocus (F₁→F₀), incubate (F₀→F₂), insight (F₂→F₃), elaborate (F₃→F₂↑→F₁↑). The filtration is not just an abstract structure. It is the shape of every deep navigational act.
...
*See also: Guide Part I (what navigation is); Guide §4.1 Class VIII (the practice of instrument-assisted navigation); the Perspectival Interface companion document (the instrument itself).*
...
*Navigation Charts — Corpus Perspectival V2 Companion Document*
