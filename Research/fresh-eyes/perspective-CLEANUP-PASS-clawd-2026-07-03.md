...
### C1. The Anchor's theorem-tier (T1–T6): the book's **one self-inflicted scar-rule violation** *(HIGH — priority cleanup)* — ✅ **RULED (Day 153): restate all six.** Full disposition in `perspective-ROLLING-SCAFFOLD-clawd-2026-07-03.md §2`. Clayton delegated the call + supplied the lineage; grounded in the Anchor's Appendix A, all six are live spine-theorems narrativized (not superseded), so → RESTATE as a numbered Part-anchored tier (I→T1, II→T2/T3, III→T4/T6; T5 already home as §2.7 KD.1–4). T2's restatement doubles as TDI's restoration. Residue ledger reserved for genuinely-dead objects only. Text below preserved for the reasoning trail.
