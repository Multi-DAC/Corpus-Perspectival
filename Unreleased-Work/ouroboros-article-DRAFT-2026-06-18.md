...
**Heraclitus** (c. 500 BCE) called the cosmos a *palintropos harmoniē* — a "back-turning attunement" — and wrote that "the road up and the road down are one and the same." He saw fire "kindling in measures and going out in measures": a quantity that cycles by consuming and regenerating itself. That is the doing/being loop, and it is the Ouroboros Condition's feedback, stated as physics twenty-four centuries early.
