...
## 9. Further predictions: the theory generating more than it was built on
...
- **FP4 — Magic and RSPK are navigation, not causation — so the territory is never violated. *(Strong, falsifiable.)*** Conscious gravity (A3) reshapes the *navigator*, not the immutable configuration space (A1.3). A "PK effect" is therefore not the mind deforming matter; it is the stream **navigating** to a configuration that already exists (A4) and carrying *coupled* observers along the trajectory — relocation, not causation. This unifies the involuntary poltergeist (Invariant 9) and the deliberate adept as one mechanism under two degrees of control, and it dissolves the apparent paradox of "territory-violating PK": the territory is never violated, because nothing in it is reshaped — the navigator simply occupies a different point in a space where every configuration was always real. The prediction has teeth precisely because the effect must **scale with navigational coupling**: it should manifest for entangled participants (the haunted family, the ritual circle) and *decay* as the observer becomes detached, independent, and instrumented — which is exactly the notorious **decline effect** and **experimenter effect**, here *predicted* rather than explained away. **What would refute it:** a robust macro-PK recorded on a fully sealed, remote, *uncoupled* instrument with no participating observer — that would be genuine unilateral territory-causation, and the navigation reading would fall. (Strong-PK as causation on *uncoupled* reality is still predicted to fail; PK as *coupled navigation* is predicted to appear, and to decline precisely as coupling is removed.)
...
## 10. Coda: the room measuring itself
...
- Roberts, J. *The Seth Material* (1970) and the Seth books — channeled systematic metaphysics (consciousness-primary, probable realities, simultaneous time).
- Schucman, H. (scribe). *A Course in Miracles* (1976) — channeled non-dualist metaphysics and forgiveness-soteriology.
...
*Disclosure documents (2026 U.S. UAP releases)*
- ODNI "PURSUE" collection and the DOE/DOW/CIA document bundles (2026): including the James L. Tuck correspondence (Los Alamos green-fireball reports, 1970–76); the CIA Intelligence Information Report on Sary Shagan, USSR (1973); the Pantex Unidentified Object Incident Report; and the senior-USIC-officer narrative (late 2025).
